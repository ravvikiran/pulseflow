...
| 1.4 | Authentication system | ✅ | No auth required — all features accessible locally |
| 1.5 | Role-based access control (user/admin) | ✅ | Default local admin, all features open |
